          ...
          <div class="row content">
            <div>
              <div style="float:right">
                <button type="button" class="btn btn-link btn-lg"><span class='bi bi-door-open' style="font-size: 30px;"></span></button> 
              </div>
            <div class="mainTop" id="top">
              ...
              <h1>WENDY AUDREY</h1>
              <h3 class="med">KARYAWAN - 000000</h3>
              <br>
              <h3>Tuesday, 17 May 2022</h3>
            ...
            <div class="d-flex justify-content-center flex-wrap" style="height: 100px" id="bottom">
              <div class="d-flex flex-column" style="padding-bottom: 50px">
                <div class="p-2" style="padding: 10px;"><a class="btn btn-primary" href="attendance.html" role="button">ABSENCE</a></div>
